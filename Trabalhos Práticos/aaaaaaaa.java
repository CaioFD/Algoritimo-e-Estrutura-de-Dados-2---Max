...
class ArvoreBinaria 
{
	...
	public boolean pesquisar (Personagem x, Log log) {
		...
		return ( pesquisar(raiz, x.getName(), log) );
	} // end pesquisar ( )
...
class Personagem 
{
    ...
    public Personagem ler ( String id )
    {
        ...
        // path = "C:\\Users\\Vinishow\\Pictures\\outros\\characters.csv";
        try 
        { 
 ...
 */
public class aaaaaaaa extends Personagem
{
    public static void main ( String [] args ) throws Exception
    {
        ...
        Log           log    = new Log( "793605_arvoreArvore.txt" );
        Personagem    perso  = new Personagem( );
